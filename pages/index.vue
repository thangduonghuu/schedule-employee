  ...
  <section class="w-full h-full bg-violet-200 rounded-2xl">
    <div class="p-4 flex items-center justify-between">
      ...
      <div class="flex gap-1">
        ...
        >
          {{
            scheduleForHalfDay ? "Schedule as full day" : "Schedule as half day"
          }}</a-button
        >
      </div>
    </div>

    <div v-if="loading" class="w-full flex justify-center items-center h-20">
      <Loading />
    </div>
            ...
            >
              <div>
                <a-typography-title
                  ...
                  :style="{
                    color:
                      day === format(new Date(), 'EEE d') ? 'red' : 'inherit',
                  }"
                >
                  {{ day }}
                </a-typography-title>
